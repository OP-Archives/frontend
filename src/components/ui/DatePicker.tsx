...
function DarkSelect({ value, options, onChange }: DropdownProps) {
  ...
  return (
    <select
      ...
      className="rounded border border-[#222230] bg-[#16161e] px-2 py-1 text-sm text-[#f0f0f5] transition-colors focus:border-[#6366f1] focus:ring-1 focus:ring-[#6366f1]/30 focus:outline-none"
    >
      {opts.map((opt) => (
