      ...
      <div className="flex flex-col rounded-t-xl bg-[#0a0a0f]/85 px-2 pb-2 backdrop-blur-md" style={{ gap: '4px' }}>
        <div className="group relative flex w-full items-center">
          <div
            ...
            className="pointer-events-none absolute bottom-full z-50 mb-3 -translate-x-1/2 transform rounded border border-[#222230] bg-[#16161e] px-2 py-1 text-xs font-medium whitespace-nowrap text-white opacity-0 shadow-md transition-opacity"
            style={{ left: '0px' }}
          />
          <div
            ref={progressBarRef}
          ...
          <div className="flex items-center" style={{ gap: '6px' }}>
            ...
            {currentChapter && (
              <>
                ...
                <span className="max-w-[120px] truncate text-[11px] font-medium text-[#f0f0f5]/60 sm:max-w-[180px] sm:text-[13px]">
                  {currentChapter.name}
                </span>
              </>
            )}
