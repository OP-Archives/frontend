...
export default function ChatSettingsModal(props: ChatSettingsModalProps) {
  ...
  return (
    ...
    >
      ...
      {/* Modal Container */}
      <div
        className={`relative z-10 flex w-full max-w-[400px] flex-col overflow-hidden rounded-xl border border-[#222230] bg-[#16161e] shadow-2xl transition-transform duration-200 ${
          showModal ? 'translate-y-0 scale-100' : 'translate-y-4 scale-95 sm:translate-y-0'
        }`}
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-[#222230] bg-[#16161e] px-4 py-3 sm:px-6 sm:py-4">
          <button
            ...
            className="text-[#9ca3af] transition-colors hover:text-[#f0f0f5]"
        ...
        <div className="chat-scrollbar flex-1 overflow-y-auto p-4 sm:p-6">
          <div className="space-y-6">
            ...
            <div>
              <p className="mb-2 text-sm font-medium text-[#9ca3af]">Font Size: {messageFontSize}px</p>
              <div className="flex w-full items-center gap-3">
                ...
                <button
                  ...
                  className={`flex h-[38px] w-[38px] items-center justify-center self-center rounded-lg border border-[#222230] bg-[#222230] transition-colors ${
            ...
            <div className="flex items-center justify-between rounded-lg border border-[#222230] p-3">
