      ...
      <ContentPage
        ...
        sections={[
          ...
          },
          {
            ...
            content: (
              <>
                ...
                <p>
                  The frontend web application uses browser localStorage exclusively to save viewer preferences locally
                  on the viewer&apos;s own device. No data from localStorage is transmitted to our servers or any third
            ...
            content: (
              <>
                <p>
                  ...
                  of upload and is not periodically re-fetched or refreshed from the YouTube API after the initial
                  upload.
                </p>
                <p>
                ...
                <p>
                  Content creators may also revoke this application&apos;s access to their YouTube account at any time
                  by visiting:
                </p>
                <p>
                  <a
          ...
          },
          {
            ...
            content: (
              <p>
                This platform is not directed at children and does not knowingly collect any information from
