        ...
        sections={[
          {
            ...
            content: (
              <p>
                op archive was built out of a simple frustration: streamers lose their VODs as Twitch and Kick don't
                keep them forever. There's also no real way to organize or share them with your community.
              </p>
            ),
          },
          {
